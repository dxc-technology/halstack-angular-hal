 ...
 */
@Component({
  selector: 'dxc-text-column',
  template: `
    <ng-container dxcColumnDef>
      <td dxc-cell *dxcCellDef="let data" [style.text-align]="justify">
...
export class DxcTextColumn<T> implements OnDestroy, OnInit {
  ...
  /** @docs-private */
  @ViewChild(DxcColumnDef, {static: true}) columnDef: DxcColumnDef;
   ...
   * @docs-private
   */
  @ViewChild(DxcCellDef, {static: true}) cell: DxcCellDef;

  constructor(
      @Optional() private _table: DxcHalTable<T>,
